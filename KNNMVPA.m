function [accuracy, Predict_test_Label,SpecificitySensitivity,weightall,FeatureAll,SelectFeatureIndex,Specif_Sensit_acc_fold,MaxDim]=KNNMVPA(Cfg)
    ...
    switch strSelectFeature
        ...
        case 'F-Score'
            ...
            for j=1:length(SelectFeatureNum)
                ...
                [predict_label, dec_values] = predict(Factor, test_datarank(:,1:kWeight));    
