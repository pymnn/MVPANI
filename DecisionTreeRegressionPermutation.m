function [rr,pp]=DecisionTreeRegressionPermutation(Cfg)
%Permutation for Decision Tree (regression)
        ...
        switch strSelectFeature
            ...
            case 'F-Score'
                ...
                for jNum=1:length(SelectFeatureNum)
                    ...
                    model = fitrtree(Frank, train_label);
                    [predict_label,score] =predict(model, test_datarank);
