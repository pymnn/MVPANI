...
save FeatureAll.mat FeatureAll
    ...
    if isempty(MaskPath)
        ...
        if sel_CheckWeightAll
            ...
            for iFeature=1:size(MeanFeature,2)
                ...
                save([OutputDir,filesep,'SelectFeatureMean_',num2str(iFeature),'.mat'],'SelectFeatureMean')
            end
        end
        if sel_CheckWeightI %output all weight
            ...
            for i=1:size(FeatureAll,2)
                for j=1:size(FeatureAll,3)
                    ...
                    save([OutputDir,filesep,'SelectFeatureMean_',num2str(i),'_Fold_',num2str(j),'.mat'],'SelectFeature')
                end
            end
        end
    else
